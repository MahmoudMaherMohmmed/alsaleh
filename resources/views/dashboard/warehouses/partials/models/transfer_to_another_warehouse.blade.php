<div class="modal" id="transfer-to-another-warehouse-model">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <p>@lang('warehouses.actions.transfer_to_another_warehouse')</p><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <form action="{{route('warehouses.transfer_to_another_warehouse')}}" method="POST">
                    @csrf
