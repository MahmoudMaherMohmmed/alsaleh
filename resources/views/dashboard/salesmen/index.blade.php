    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('salesmen.plural') }}</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            @include('dashboard.salesmen.partials.actions.create')
        </div>
    </div>
    <!-- breadcrumb -->
@endsection
                        ...
                        <table class="table text-md-nowrap" id="example2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">{{ __('salesmen.actions.actions') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($salesmen as $salesman)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge {{$salesman->status->color()}}">{{$salesman->status->trans()}}</span>
                                        </td>
                                        <td>{{$salesman->created_at->diffForHumans()}}</td>
                                        <td>
                                            @include('dashboard.salesmen.partials.actions.show')
