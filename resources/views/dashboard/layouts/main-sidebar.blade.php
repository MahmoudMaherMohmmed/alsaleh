            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                         src="{{
                        (Auth::user() && Auth::user()->image) ? url(Auth::user()?->image) : create_avatar(auth()->user()->name??'admin')
                        }}"><span
        ...
        <ul class="side-menu">
            <li class="slide">
                <a class="side-menu__item" href="{{ route('home') }}">
                    ...
                    <span class="side-menu__label">{{ __('dashboard.home') }}</span></a>
            </li>
            ...
            @include('dashboard.expenses.company.partials.actions.sidebar')
            ...
            @include('dashboard.areas.partials.actions.sidebar')
